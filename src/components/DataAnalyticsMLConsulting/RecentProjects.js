      ...
      <div className="container">
        <div className="section-title">
          <span className="sub-title">
            <img src={StarIcon} alt="image" /> Recent Blogs
          </span>
          <h2>Check Some Of Our Recent Blogs</h2>
          {/* <p>
        ...
        <div className="row">
          <div className="col-lg-4 col-md-6">
            <div className="single-projects-box">
              <div className="image">
                ...
                <Link to="/blog-details-marketing" className="link-btn">
                  <i className="bx bx-plus"></i>
                </Link>
              </div>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="single-projects-box">
              <div className="image">
                ...
                <Link to="/blog-details-pricing" className="link-btn">
                  <i className="bx bx-plus"></i>
                </Link>
              </div>
              ...
              <div className="content">
                <h3>
                  <Link to="/blog-details-pricing">Pricing Strategies!!</Link>
                </h3>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="single-projects-box">
              <div className="image">
                ...
                <Link to="/blog-details-reliance" className="link-btn">
                  <i className="bx bx-plus"></i>
                </Link>
              </div>
              ...
              <div className="content">
                <h3>
                  <Link to="/blog-details-reliance">
                    Reliance - The Debt Free Empire
                  </Link>
                </h3>
          ...
          {/* <div className="col-lg-4 col-md-6">
            <div className="single-projects-box">
              ...
              <div className="content">
                <h3>
                  <Link to="/case-studies-details">Detection Project</Link>
                </h3>
          ...
          {/* <div className="col-lg-4 col-md-6">
            <div className="single-projects-box ">
              ...
              <div className="content">
                <h3>
                  <Link to="/case-studies-details">Data Scientist</Link>
                </h3>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="single-projects-box">
              ...
              <div className="content">
                <h3>
                  <Link to="/case-studies-details">Benefits Research</Link>
                </h3>
